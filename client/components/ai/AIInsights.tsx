...
const mockInsights: AIInsight[] = [
  {
    ...
    description:
      "Carol Davis shows 73% probability of policy cancellation within 30 days based on payment delays and reduced engagement.",
    confidence: 87,
    impact: "High",
  ...
  },
  {
    ...
    description:
      "Alice Johnson recently purchased a home (detected via social signals). High probability for home insurance conversion.",
    confidence: 92,
    impact: "High",
  ...
  },
  {
    ...
    description:
      "Claim CLM-003 exhibits patterns similar to 47 known fraudulent cases. Document analysis shows inconsistencies.",
    confidence: 83,
    impact: "Critical",
  ...
  },
  {
    ...
    description:
      "Market analysis suggests adjusting rates for Auto Insurance by +8% while maintaining 94% retention probability.",
    confidence: 89,
    impact: "Medium",
    category: "Revenue Optimization",
  ...
  },
  {
    ...
    description:
      "Sarah Williams could increase conversion by 23% with targeted training on health insurance products.",
    confidence: 78,
    impact: "Medium",
...
export default function AIInsights({
  ...
  const handleRefresh = async () => {
    ...
    setTimeout(() => {
      ...
      setInsights((prev) =>
        prev.map((insight) => ({ ...insight, isNew: false })),
      );
      ...
      <Card>
        ...
        <CardContent className="space-y-3">
          {filteredInsights.map((insight) => (
            <div
              key={insight.id}
              className="p-3 border rounded-lg dark:border-gray-700 relative"
            >
              {insight.isNew && (
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center space-x-2 mb-1">
                    <div
                      className={cn("p-1 rounded", getTypeColor(insight.type))}
                    >
        ...
        {filteredInsights.slice(0, 3).map((insight) => (
          <Card key={insight.id} className="relative overflow-hidden">
            ...
            <CardHeader className="pb-3">
              <div className="flex items-center space-x-2">
                <div
                  className={cn("p-2 rounded-lg", getTypeColor(insight.type))}
                >
                  {getTypeIcon(insight.type)}
                </div>
                <div className="flex-1">
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Real-time analysis and recommendations powered by machine
                learning
              </CardDescription>
            </div>
            <Button
