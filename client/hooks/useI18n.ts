...
const translations = {
  en: {
    ...
    'dashboard.subtitle': 'Welcome back! Here\'s what\'s happening with your insurance business today.',
    ...
    'settings.subtitle': 'Manage your application preferences and global settings.',
  ...
  hi: {
    ...
    'dashboard.subtitle': 'वापसी पर स्���ागत! यहाँ आज आपके बीमा व्यवसाय के साथ क्या हो रहा है।',
    ...
    'settings.subtitle': 'अपनी एप्लिकेशन प्राथमिकताएं और वैश्विक सेटिंग्स प्रबंधित करें।',
  ...
  es: {
    ...
    'dashboard.subtitle': '¡Bienvenido! Esto es lo que está pasando con tu negocio de seguros hoy.',
    ...
    'settings.subtitle': 'Gestiona tus preferencias de aplicación y configuraciones globales.',
